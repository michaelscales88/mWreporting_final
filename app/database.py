...
local_session = get_scoped_session(db.engine)
app_session = get_scoped_session(db.get_engine(app, 'app_meta'))
data_session = get_scoped_session(db.get_engine(app, 'ext_data'))
